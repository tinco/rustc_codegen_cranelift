...
impl WasmModule {
    ...
    fn write_stream<W: std::io::Write>(
    ...
    ) -> Result<(), Box<dyn std::error::Error>> {
        {
            ...
            waffle_func.set_terminator(
                waffle_func.entry,
                waffle::Terminator::Return { values: vec![allocated] },
            );
            ...
            for inst in ctx.func.layout.block_insts(block) {
                match ctx.func.dfg.insts[inst].opcode() {
                    ...
                    Opcode::Iconst => {
                        ...
                        b.emit(
                            inst,
                            match b.clif_func.dfg.ctrl_typevar(inst) {
                    ...
                    Opcode::GlobalValue => {
                        ...
                        b.emit(
                            inst,
                            waffle::Operator::GlobalGet { global_index: self.data_ids[&data_id] },
                        );
                    }
                    Opcode::StackAddr => {
                    ...
                    Opcode::Return => {
                        ...
                        b.waffle_func.set_terminator(
                            b.block_map[&block],
                            waffle::Terminator::Return { values: returns },
                        );
                    }
                    _ => {
